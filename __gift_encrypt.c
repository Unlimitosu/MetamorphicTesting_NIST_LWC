...
static int __gift_cofb_crypt(unsigned char *out, unsigned char *k, unsigned char *n,
...
void __gift_cofb_encrypt(unsigned char *c, unsigned char *k, unsigned char *n,
    ...
    __gift_cofb_crypt(c, k, n, a, abytes, p, pbytes, COFB_ENCRYPT);
}
...
int __gift_cofb_decrypt(unsigned char *p, unsigned char *k, unsigned char *n,
    ...
    return __gift_cofb_crypt(p, k, n, a, abytes, c, cbytes, COFB_DECRYPT);
}
...
)
{
    (void)nsec;
    *clen = mlen + TAGBYTES;
    __gift_cofb_crypt(c, (unsigned char *)k, (unsigned char *)npub, (unsigned char *)ad,
...
)
{
    (void)nsec;
    *mlen = clen - TAGBYTES;
    return __gift_cofb_crypt(m, (unsigned char *)k, (unsigned char *)npub,
